...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{final_price_distribution.png}
\caption{Phân phối giá cuối cùng của hai bộ dữ liệu. Hai phân phối có mặt bằng tương đồng, giúp so sánh hành vi khách hàng và tài xế trên cùng thang giá.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{trip_spatial_distribution.png}
\caption{Phân bố tọa độ điểm đi và điểm đến trong dữ liệu synthetic. Các chuyến được lấy mẫu trên lưới không gian 10 x 10, tạo dữ liệu đủ đa dạng cho biến khu vực và quãng đường.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{distance_duration_relationship.png}
\caption{Quan hệ giữa quãng đường và thời lượng chuyến đi. Đường xu hướng dương xác nhận thời lượng tăng theo khoảng cách, trong khi các ngữ cảnh mưa/cao điểm làm thời lượng phân tán cao hơn.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{driver_model_comparison.png}
\caption{So sánh các mô hình dự đoán phụ phí phía tài xế. Việc thêm khu vực và hiệu ứng tài xế làm giảm RMSE, đồng thời tăng khả năng giải thích trên tập kiểm tra.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{acceptance_by_context.png}
\caption{Tỷ lệ chấp nhận của khách hàng và tài xế theo bốn ngữ cảnh. Khách hàng chấp nhận cao hơn trong mưa/cao điểm, trong khi tài xế giảm tỷ lệ nhận do chi phí vận hành tăng.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{driver_supply_curves.png}
\caption{Đường cung dự đoán của tài xế theo giá trả. Khi giá trả tăng, xác suất nhận chuyến tăng; các đường trong mưa/cao điểm nằm thấp hơn do điều kiện vận hành bất lợi.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{customer_demand_curves.png}
\caption{Đường cầu dự đoán của khách hàng theo giá thu. Xác suất đặt xe giảm khi giá tăng, nhưng các ngữ cảnh mưa/cao điểm dịch đường cầu lên trên do nhu cầu cấp thiết.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{acceptance_by_price_bin.png}
\caption{Tỷ lệ chấp nhận theo khoảng giá. Đường của khách hàng thể hiện xu hướng giảm khi giá tăng, còn đường của tài xế phản ánh động lực nhận chuyến tốt hơn ở mức thù lao cao.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{delta_price_by_context.png}
\caption{Phụ phí trung bình theo ngữ cảnh. Mưa và giờ cao điểm làm phụ phí tăng rõ rệt; tổ hợp mưa cộng cao điểm tạo mức phụ phí cao nhất.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{optimal_prices_by_context.png}
\caption{Cặp giá tối ưu theo ngữ cảnh trong lưới giá khảo sát. Việc một số nghiệm chạm biên trên của lưới cho thấy bài toán tối ưu cần được ràng buộc thêm bằng chính sách trải nghiệm khách hàng, cạnh tranh hoặc trần giá thực tế.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{profit_heatmap.png}
\caption{Heatmap lợi nhuận kỳ vọng trong ngữ cảnh mưa cộng cao điểm. Vùng màu đậm biểu diễn các cặp giá có lợi nhuận kỳ vọng cao hơn; dấu sao đánh dấu điểm tốt nhất trong lưới giá đang xét.}
\end{figure}
